...
routes.get('/login', userController_1.showUsers, homeController.logged);
routes.post('/login', userController_1.showUsers, userController.onUser, userController_1.showUsers, homeController.logged);
routes.get('/list/all', userController_1.showUsers, userController.onUser, homeController.allArea);
routes.get('/list/animals', userController_1.showUsers, userController.onUser, homeController.animalsArea);
routes.get('/list/landscape', userController_1.showUsers, userController.onUser, homeController.landscapeArea);
routes.get('/list/vaporwave', userController_1.showUsers, userController.onUser, homeController.vaporwaveArea);
